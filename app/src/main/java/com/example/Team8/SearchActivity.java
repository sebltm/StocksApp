...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Stock> stockAdapter = new StockAdapter(this, R.layout.stock_dropdown_item, new ArrayList<Stock>());
        ...
        searchSymbol.setOnClickListener(v -> {
            ...
            if(currentSearch.length() <= 2) {
                Toast.makeText(this, "Your query needs to be at least 3 characters long", Toast.LENGTH_SHORT).show();
                return;
            }
